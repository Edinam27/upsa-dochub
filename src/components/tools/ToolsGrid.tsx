...
const ToolsGrid = () => {
  const tools: Tool[] = [
    // Organize PDFs Category
    {
      ...
      color: 'from-[var(--color-joedy-navy)] to-[var(--color-joedy-navy-light)]',
    ...
    },
    {
      ...
      category: 'Organize PDFs',
      color: 'from-[var(--color-joedy-cyan)] to-[var(--color-joedy-cyan-dark)]',
    ...
    },
    {
      ...
      category: 'Organize PDFs',
      color: 'from-[var(--color-joedy-navy-light)] to-[var(--color-joedy-navy)]',
    ...
    },
    {
      ...
      category: 'Organize PDFs',
      color: 'from-[var(--color-joedy-cyan-dark)] to-[var(--color-joedy-cyan)]',
    ...
    // Conversion Tools Category
    {
      ...
      color: 'from-[var(--color-joedy-navy)] to-[var(--color-joedy-cyan)]',
    ...
    },
    {
      ...
      category: 'Conversion Tools',
      color: 'from-[var(--color-joedy-cyan)] to-[var(--color-joedy-navy)]',
    ...
    },
    {
      ...
      category: 'Conversion Tools',
      color: 'from-[var(--color-joedy-navy)] to-[var(--color-joedy-cyan-dark)]',
    ...
    },
    {
      ...
      category: 'Conversion Tools',
      color: 'from-[var(--color-joedy-cyan)] to-[var(--color-joedy-navy-light)]',
    ...
    // Enhancement Tools Category
    {
      ...
      color: 'from-[var(--color-joedy-cyan-dark)] to-[var(--color-joedy-navy)]',
    ...
    },
    {
      ...
      category: 'Enhancement Tools',
      color: 'from-[var(--color-joedy-navy-light)] to-[var(--color-joedy-cyan)]',
    ...
    },
    {
      ...
      category: 'Verification Tools',
      color: 'from-[var(--color-joedy-cyan-dark)] to-[var(--color-joedy-navy-light)]',
      isLocked: true,
