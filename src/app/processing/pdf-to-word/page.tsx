...
export default function PDFToWordProcessingPage() {
  ...
  const handleStartProcessing = async (files: File[], options?: any) => {
    ...
    try {
      const processor = createPDFProcessor('pdf-to-word', options);
      if (!processor) {
        throw new Error('Processor not found for pdf-to-word');
      }
      ...
      if (results.length > 0) {
        ...
        results.forEach((processedFile: any) => {
          ...
          if (url) {
            ...
            a.href = url;
            a.download = processedFile.name || `converted-${Date.now()}.docx`;
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-semibold text-gray-900">PDF to Word Converter</h1>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center space-x-3">
              {processingStatus === 'processing' && (
                <>
                  ...
                  <span className="text-blue-800 font-medium">Converting PDF to Word...</span>
                </>
              )}
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="p-6">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">PDF to Word File Type Converter</h2>
              <p className="text-gray-600">
                Convert PDF documents to Word format with optimized file type conversion, focusing on PDFs that originated from Word documents
              </p>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-gray-600 text-sm">
              Maintains formatting and layout while converting to editable Word format.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-gray-600 text-sm">
              Download your converted Word documents immediately after processing.
            </p>
          </div>
        </div>
      </div>
